...
namespace EnergyComparer
{
    public class Worker
    {
        ...
        private (IHardwareMonitorService, IOperatingSystemAdapter, IHardwareHandler, IWifiService, IExperimentHandler) InitializeOfflineDependencies()
        {
            ...
            var adapter = SystemUtils.InitializeAdapterService(_logger, _isProd,  _shouldRestart, hardwareMonitorService, _machineName);
        ...
        private void InitializeDependencies()
        {
            ...
            _adapterService = SystemUtils.InitializeAdapterService(_logger, _isProd, _shouldRestart, _hardwareMonitorService, _machineName);
