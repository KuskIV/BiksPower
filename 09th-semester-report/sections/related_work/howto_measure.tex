...
When measuring the energy consumption of a test program, there exists various different ways of proceeding. In the work by Hackenberg et al.\cite*[]{Hackenberg2013} Intelegent Platform Management Interface (IMPI) based platforms like power supplies with measurement features, model-based interfaces like RAPL or APM and physical measurements including AC and DC are compared, with an aim of uncovering aspects of accuracy, temporal resolution and measurement overhead.

Here it is noted that intels RAPL has previouly been shown to be reasonably accurate, and is deemed a viable alternative to physical measureemnts\cite*[]{Dongarra2012,Hackenberg2013}.\todo[]{Jeppe write this when you have presented the paper}
