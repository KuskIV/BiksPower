...
When considering the results in work by Pereira et al.\cite[]{Pereira2017}, the energy consumption of a given test case is given in joules and a duration in seconds. When comparing the energy consumption against the measurements in this work, it is done so by calculating the average energy consumption in joules, given the time by Pereira\cite[]{Pereira2017}, e.i. if Fasta was reported to use $50$ joules in $10$ seconds and the measurements from this work were $25$ joules for $5$ seconds, the energy consumption will be scaled to have the same time, i.e. $25J*2=50$. Following this, it is time to present the expectations.
