...
\paragraph*{}
Our work only considers C\#, where the test cases chosen for future work, could include some additional languages. This could be used to extend the analysis of the different measuring instruments.\todo{En nice to have var at i appendix kunne stå hvor i rapporten en figur er relevant.}