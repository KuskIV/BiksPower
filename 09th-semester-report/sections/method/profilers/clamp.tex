...
To determine what to use in our work a MoSCoW analysis has been made below. To make the criteria knowledge gathered from \cref{ch:related_work} is used.\todo{make this using more pretty MoSCow}
