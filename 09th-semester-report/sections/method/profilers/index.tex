...
Energy predictive models are models estimating the energy consumption based on performance monitoring counters and will be used by E3 in some cases\todo{RAPL bruger da også hardware counters}, depending on the hardware of the DUT. Lastly, a hardware measuring instrument is also included and will serve as the ground truth.
