...
The Intel Power Gadget\cite[]{powergadget} is a software tool for measuring the power consumption of Intel Core processors from the 2nd to 10th generation, for both Windows and macOS. What this software tool offers, is real-time \todo[]{Measurement or estimation?} estimations of the energy consumption in watts using the energy counters in the processors. 
