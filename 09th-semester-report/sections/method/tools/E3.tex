...
Examples of the full measurements and an example with only the attributes that is relevant for this study can be found in the appendix, like with the other measurement tools. \todo[]{Actually do this}
