...
However another limitation is the poor driver support. There are only drivers available for the linux kernel and therefore not for Windows.\cite{RAPL_in_action}  \todo[]{More depth would be nice}
