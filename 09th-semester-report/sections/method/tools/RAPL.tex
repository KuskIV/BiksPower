...
Another limitation is the poor driver support. There are only drivers available for the linux kernel, and not for other popular operating system like Windows or MacOS.\cite{RAPL_in_action}  \todo[]{More depth would be nice}
