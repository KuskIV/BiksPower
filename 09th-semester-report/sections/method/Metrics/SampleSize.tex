...
Lastly, there is another version of Cochran's formula shown in \cref{cochransEQ2}, Which is for continuous data. \todo{instead of margin of error maybe desired relative error margin and mean of the population}
