...
Here the method for statistically comparing the distribution of the different measurement will be elaborated and explained. The selection of the varies statical methods for distributions are in inspired by Koedijk et al\cite{koedijk2022finding}
...
The $H_0$: \textit{The two samples are from the same distribution}.
