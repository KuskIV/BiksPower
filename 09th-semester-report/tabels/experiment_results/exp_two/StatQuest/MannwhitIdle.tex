\begin{figure}[H]
  \centering
    \begin{tikzpicture}[scale=0.6]
      \foreach \y [count=\n] in {{1.00, 0.00, 0.00, 0.00},{0.00, 1.00, 0.00, 0.00},{0.00, 0.00, 1.00, 0.00},{0.00, 0.00, 0.00, 1.00},} {
      % column labels
    ...
    \end{tikzpicture}
    \caption{Here the results for the Idle case on the Mann Whitney U Test can be seen. The Range in $0 - 1$}
    \label{tab:HeatTestCaseIdle2}
\end{figure}