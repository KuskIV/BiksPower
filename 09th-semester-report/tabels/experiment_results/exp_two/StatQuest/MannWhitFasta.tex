\begin{figure}[H]
  \centering
    \begin{tikzpicture}[scale=0.6]
      \foreach \y [count=\n] in {{1.00, 0.16, 0.00, 0.00},{0.16, 1.00, 0.00, 0.00},{0.00, 0.00, 1.00, 0.00},{0.00, 0.00, 0.00, 1.00},} {
      % column labels
    ...
    \end{tikzpicture}
    \caption{Here the results for the Fasta on the Mann Whitney U Test can be seen. The Range in $0 - 1$}
    \label{tab:HeatFasta2}
    \end{figure}