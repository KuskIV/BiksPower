                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}
                        ...
                        \end{axis}
                    \end{tikzpicture} 
                \caption{A graph illustrating the energy consumption of Dram for test case BinaryTrees with regards to the temperature of the DUT (with outliers)} \label{fig:BinaryTrees_Dram_temperature_exp2}
                \end{figure}
