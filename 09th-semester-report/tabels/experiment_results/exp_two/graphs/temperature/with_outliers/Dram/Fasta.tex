                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}
                        ...
                        \begin{axis}[
                            ...
                            (35, 0.0)(40, 0.0)(45, 0.0)(50, 0.0)(60, 0.0)
                            };
                        ...
                        \end{axis}
                    \end{tikzpicture} 
                \caption{A graph illustrating the energy consumption of Dram for test case Fasta with regards to the temperature of the DUT, experiment \#2, (with outliers)} \label{fig:Fasta_Dram_temperature_exp2}
                \end{figure}
