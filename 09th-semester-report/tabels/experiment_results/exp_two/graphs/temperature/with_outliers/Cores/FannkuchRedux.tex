                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}
                        ...
                        \end{axis}
                    \end{tikzpicture} 
                \caption{A graph illustrating the energy consumption of Cores for test case FannkuchRedux with regards to the temperature of the DUT (with outliers)} \label{fig:FannkuchRedux_Cores_temperature_exp2}
                \end{figure}
