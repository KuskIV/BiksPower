                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}
                        ...
                        \end{axis}
                    \end{tikzpicture} 
                \caption{A graph illustrating the energy consumption of Dram for test case FannkuchRedux with regards to how long ago the DUT was restarted (with outliers)} \label{fig:FannkuchRedux_Dram_iteration_exp2}
                \end{figure}
