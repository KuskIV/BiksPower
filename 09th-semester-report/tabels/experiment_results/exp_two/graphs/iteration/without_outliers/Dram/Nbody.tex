                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}
                        ...
                        \end{axis}
                    \end{tikzpicture} 
                \caption{A graph illustrating the energy consumption of Dram for test case Nbody with regards to how long ago the DUT was restarted (without outliers)} \label{fig:Nbody_Dram_iteration_exp2}
                \end{figure}
