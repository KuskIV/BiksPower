                            ...
                            \begin{figure}
                                ...
                                \begin{tikzpicture}[]
                                    ...
                                    \end{axis}
                                \end{tikzpicture}
                            \caption{R3 validation for energy measurements by IntelPowerGadget for the Dram for DUT PowerKomplett, OS Win32NT and test case FannkuchRedux, where the impact of the first profiler can be seen (with outliers)} \label{fig:PowerKomplett_IntelPowerGadget_Dram_R3_energy_with_outliers_Win32NT_avg_watts}
                            \end{figure}
