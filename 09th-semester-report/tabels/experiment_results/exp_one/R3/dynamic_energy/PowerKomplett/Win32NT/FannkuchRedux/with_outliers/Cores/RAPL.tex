                            ...
                            \begin{figure}
                                ...
                                \begin{tikzpicture}[]
                                    ...
                                    \end{axis}
                                \end{tikzpicture}
                            \caption{R3 validation for dynamic energy measurements by RAPL for the Cores for DUT PowerKomplett, OS Win32NT and test case FannkuchRedux, where the impact of the first profiler can be seen (with outliers)} \label{fig:PowerKomplett_RAPL_Cores_R3_dynamic_energy_with_outliers_Win32NT_avg_watts}
                            \end{figure}
