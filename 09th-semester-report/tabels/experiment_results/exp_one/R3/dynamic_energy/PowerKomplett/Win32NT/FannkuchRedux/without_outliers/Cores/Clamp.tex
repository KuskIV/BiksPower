                            ...
                            \begin{figure}
                                ...
                                \begin{tikzpicture}[]
                                    ...
                                    yticklabels={
                                        FannkuchRedux - IPG, FannkuchRedux - LHM, FannkuchRedux - CLAMP, FannkuchRedux - IPG, FannkuchRedux - LHM, FannkuchRedux - CLAMP, FannkuchRedux - CLAMP (win)
                                        },
                                        xmin=0,xmax=70,
                                        ]
                                    ...
                                    \end{axis}
                                \end{tikzpicture}
                            \caption{R3 validation for dynamic energy measurements by Clamp for the Cores for DUT PowerKomplett, OS Win32NT and test case FannkuchRedux, where the impact of the first profiler can be seen (without outliers)} \label{fig:PowerKomplett_Clamp_Cores_R3_dynamic_energy_without_outliers_Win32NT_avg_watts}
                            \end{figure}
