\begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
      ...
      \end{tikzpicture}
    \caption{This heat map represents Correlation coefficients between the different measuring instruments -1 to 1 on the Surface Book}
    \label{tab:correlationSurfB}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
      \centering
      \begin{tikzpicture}[scale=0.6]
      ...
      \end{tikzpicture}
    \caption{This heat map represents Correlation coefficients between the different measuring instruments -1 to 1 on the Surface Pro 4}
    \label{tab:correlationSurfP}
    \end{subfigure}
    \caption{}
    \label{tab:CompbinedSurfBP}
\end{figure}